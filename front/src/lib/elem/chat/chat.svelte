...
<script lang="ts">
	import { Chat_c } from "@/type/chat";
	import { app } from "../../../store/appStore";
	import { us } from "../../../store/userStore";
	import Msg from "./msg.svelte";

  export let chat: Chat_c = new Chat_c();
</script>
...
<div class="w-full">
  ...
  <div class="grid pb-11">
    <div class="flex gap-2.5 mb-4">
      <img src="https://pagedone.io/asset/uploads/1710412177.png" alt="Shanay" class="w-10 h-11">
      <div class="grid">
  ...
  <div class="flex gap-2.5 justify-end pb-40">
    ...
    <img src="https://pagedone.io/asset/uploads/1704091591.png" alt="Hailey" class="w-10 h-11">
  </div> -->
  <!-- Btn retour -->
  <div class="w-screen bg-white z-10">
    <button on:click={()=>  {window.history.back(); $app.footer = true}}
      class="h-6 w-6 fixed left-4 bottom-2">
  ...
  <div class="w-full flex justify-center">
    <div class="fixed bottom-0 min-w-[80%] pl-3 pr-1 py-1 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between">
