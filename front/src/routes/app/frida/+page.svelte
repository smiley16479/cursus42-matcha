  ...
  {:else}
    <div class="absolute top-8">
      <button
        ...
        class="inline-block px-4 py-2 bg-gray-200 text-gray-800 sm:text-xl md:text-2xl lg:text-3xl font-semibold rounded-lg no-underline hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition border border-black"
      >
